...
//                     onKeyDown={handleKeyDown}
//                     placeholder="Password"
//                     className={`w-full border p-2 rounded pr-10 text-[16px] text-black focus:outline-none focus:ring-2 ${
//                       error ? "border-red-500 ring-red-200" : "border-gray-300 ring-[#EAB968]"
//                     }`}
//                   />
//                   <button
...
//       {/* ✅ DESKTOP UI */}
//       <div className="hidden md:flex justify-center items-center h-screen w-full bg-gradient-to-br from-yellow-100 to-white">
...
//             This system is optimized for mobile screens. Please switch to a phone or smaller device to access the app.
//           </p>

//           {/* QR Code placeholder */}
//           <div className="flex justify-center mb-4">
//             <div className="w-40 h-40 border-2 border-dashed border-gray-400 flex items-center justify-center text-gray-400">
//               QR Code
//             </div>
//           </div>

//           <p className="text-md text-gray-500">
//             Scan this code on your phone to open the mobile version.
//           </p>
//         </div>
//       </div>
//     </>
